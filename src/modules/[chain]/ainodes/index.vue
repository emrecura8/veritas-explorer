...
<template>
  <div>
    <div class="bg-base-100 px-4 pt-3 pb-4 rounded mb-4 shadow">
      <h2 class="card-title truncate mb-2">{{ $t('ainodes.title') }}</h2>
      <div class="text-sm">
        {{ $t('ainodes.title') }}
    ...
    <div class="bg-base-100 px-4 pt-3 pb-4 rounded mb-4 shadow">
      ...
      <div class="text-sm">
        1. {{ $t('ainodes.text_1') }} ({{ appName }} {{ $t('ainodes.version') }}:
        {{ nodeInfo.application_version?.version || '' }})
        <br />
        {{ $t('ainodes.text_1_1') }}.
        <br />
        <br />
        2. {{ $t('ainodes.text_2') }}<br />
        {{ $t('ainodes.text_2_1') }}.
        <br /><br />
    ...
    <div class="bg-base-100 px-4 pt-3 pb-4 rounded shadow">
      <h2 class="card-title truncate mb-2">{{ $t('ainodes.title_3') }}</h2>
      <div class="text-sm">
        {{ $t('ainodes.text_title_3') }}
        <br /><br />
        <div class="mockup-code bg-base-200 my-2">
          <pre data-prefix=">"><code class="text-gray-800 dark:invert">[state-sync]</code></pre>
          <pre
